...
const ERR_MESSAGE: Record<string, string> = {
  ...
  consent_required: "Bạn cần xác nhận thông tin đơn hàng và đồng ý cho lưu lại để tiếp tục.",
  invoice_required: "Vui lòng tải lên ít nhất 1 ảnh thông tin đơn hàng.",
